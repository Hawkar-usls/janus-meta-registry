#!/usr/bin/env python3
"""Clean R3C-2 logos conformance recovery wrapper v0.1.1.

No D5/D6 target, case list, or grading rule is changed. The wrapper only binds
the frozen v0.1 conformance runner to the admitted v0.4 source loader and adds
clean-recovery provenance after re-execution from source bytes.
"""
...
import janus_linear_a_r3c_logos_defect_replay_v0_1 as base
...
def main() -> None:
    ...
    d["artifact_uuid"] = "JANUS-LINEAR-A-R3C-2-LOGOS-DEFECT-CONFORMANCE-RESULT-2026-08-14-v0.1.1"
    d["version"] = "v0.1.1"
    d["recovery_lineage"] = {
        "scientific_method_runner": "research/linear_a/janus_linear_a_r3c_logos_defect_replay_v0_1.py",
